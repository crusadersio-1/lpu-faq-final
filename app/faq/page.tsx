  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-50 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-6">
              ...
              <Link href="/faq" className="text-[#8B0000] font-bold">FAQ</Link> {/* Highlight FAQ */} 
              <Link href="/contact" className="text-gray-700 hover:text-[#8B0000] font-medium">Contact</Link>
            </div>
            <div className="flex items-center space-x-4">
              <button
                onClick={handleAdminClick}
                className="px-4 py-2 bg-[#8B0000] text-white rounded-lg font-medium hover:bg-[#6B0000] transition-colors duration-200"
              >
                Admin Panel
              </button>
            </div>
      ...
      <main className="flex-grow container mx-auto px-4 py-12">
        ...
        <p className="text-center text-gray-600 mb-12">Find answers to the most common questions about our school and services.</p>
                ...
                faqs.map((faq, index) => (
                  <div key={faq.id} className="border-b border-gray-200 last:border-b-0">
                    <button
                      ...
                      className="flex justify-between items-center w-full py-4 text-left font-medium text-gray-700 hover:text-[#8B0000] focus:outline-none"
                    >
        ...
        <div className="text-center mt-12">
            <p className="text-gray-600 mb-4">Don't see what you're looking for? Try our AI Assistant or contact us directly.</p>
            <div className="flex justify-center space-x-4">
                ...
                <Link 
                  href="/ticket" 
                  className="px-6 py-3 border border-gray-300 text-gray-700 rounded-lg font-medium hover:bg-gray-100 transition-colors duration-200"
                >
                    Contact Support
                </Link>
            </div>
